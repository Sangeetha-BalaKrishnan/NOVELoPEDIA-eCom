		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				<ul class="nav navbar-nav">
					...
					<li id="product" style="font-size: 20px"><a	href="${contextRoot}/show/all/products">Product</a></li>
					<li id="manageProducts" style="font-size: 20px"><a	href="${contextRoot}/manage/products">Manage Products</a></li>
